...
PRESET_CONFIG: dict[str, dict] = {
    ...
    "ema_cross_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    ...
    "rsi_divergence_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 5. MACD momentum (импульс по MACD) ────────────────────────────────
    "macd_momentum_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "macd_momentum_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 6. MACD histogram trend (рост/падение гистограммы) ────────────────
    "macd_hist_trend_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "macd_hist_trend_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 7. Bollinger Bounce (отскок от полос) ─────────────────────────────
    "bb_bounce_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "bb_bounce_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 8. Bollinger Squeeze Breakout (сжатие + пробой) ───────────────────
    "bb_squeeze_breakout_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "bb_squeeze_breakout_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 9. Stochastic bounce (отскок от перепроданности/перекупленности) ──
    "stoch_bounce_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "stoch_bounce_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 10. Stochastic OB/OS (уровни 20/80) ───────────────────────────────
    "stoch_obos_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "stoch_obos_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 11. VWAP return (возврат к VWAP после отклонения) ────────────────
    "vwap_return_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "vwap_return_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 12. VWAP band (отбой от полосы VWAP) ──────────────────────────────
    "vwap_band_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "vwap_band_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 13. ATR breakout (пробой волатильности) ──────────────────────────
    "atr_breakout_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "atr_breakout_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 14. ATR trailing (следование за ATR) ──────────────────────────────
    "atr_trailing_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "atr_trailing_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 15. Volume spike (всплеск объёма + направление цены) ─────────────
    "volume_spike_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "volume_spike_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 16. Volume trend (тренд по объёму) ────────────────────────────────
    "volume_trend_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "volume_trend_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 17. Supertrend (следование за трендом) ────────────────────────────
    "supertrend_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "supertrend_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 18. Supertrend re-entry (повторный вход при смене тренда) ─────────
    "supertrend_reentry_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "supertrend_reentry_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 19. ADX strength (сильный тренд по ADX + EMA) ────────────────────
    "adx_trend_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "adx_trend_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 20. Ichimoku (стратегия на основе облака Ишимоку) ────────────────
    "ichimoku_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "ichimoku_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 21. Ichimoku TK cross (кросс Tenkan/Kijun) ────────────────────────
    "ichimoku_tk_cross_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "ichimoku_tk_cross_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 22. Morning Star (бычья свечная паттерн) ──────────────────────────
    "morning_star": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 23. Evening Star (медвежья свечная паттерн) ───────────────────────
    "evening_star": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    # ── 24. Engulfing (поглощающая свечная паттерн) ───────────────────────
    "engulfing_long": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
    "engulfing_short": {"tp": 1.5, "sl": 0.5, "max_per_preset": 0},
