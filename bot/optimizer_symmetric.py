    ...
    if all_trades:
        def entry_key(t):
            try:
                ...
                return ""
        all_trades_sorted = sorted(all_trades, key=entry_key)
    ...
    if args.apply:
        ...
        for r in results:
            ...
            try:
                ...
                cfg["sl_pct"] = r["sl_tp_pct"]
                cfg["tp1_pct"] = r["sl_tp_pct"]
                cfg["tp2_pct"] = r["sl_tp_pct"]
                ...
                print(f"  Updated {os.path.basename(cfg_file)} | SL=TP={r['sl_tp_pct']}% EMA={r['ema_fast']}/{r['ema_slow']}")
                applied += 1
